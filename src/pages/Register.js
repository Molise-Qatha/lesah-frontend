...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic password strength (backend also validates)
    ...
    // Hardcoded local backend URL (change to your Render URL later)
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input
                  type="email"
                  name="email"
                  placeholder="student@university.ac.ls"
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  type="tel"
                  name="phone_number"
                  placeholder="56613551 or +26612345678"
